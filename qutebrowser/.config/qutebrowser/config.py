...
# AppCache. Note that with QtWebKit, only `all` and `never` are
# supported as per-domain values. Setting `no-3rdparty` or `no-
# unknown-3rdparty` per-domain on QtWbKit will have the same effect as
# `all`.
# Type: String
# Valid values:
#   - all: Accept all cookies.
...
# Type: Font
c.fonts.completion.entry = '12pt "Andika"'

# Font used for the debugging console.
# Type: Font
c.fonts.debug_console = '12pt "Andika"'

# Font used for prompts.
# Type: Font
c.fonts.prompts = '12pt "Andika"'
